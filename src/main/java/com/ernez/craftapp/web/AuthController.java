...
import com.ernez.craftapp.dto.request.SignupRequest;
import com.ernez.craftapp.dto.response.JwtResponse;
import com.ernez.craftapp.dto.response.MessageResponse;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "mod":
					Role modRole = roleRepository.findByName(ERole.ROLE_REPAIRER)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(modRole);
